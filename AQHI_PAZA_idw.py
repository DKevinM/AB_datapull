...
airshed = gpd.read_file("data/PAZA_AEPA.shp").to_crs(gdf.crs)
...
grid_gdf[["lon", "lat", "AQHI_IDW", "NearestReading"]].to_csv("data/AQHI_PAZA_idw.csv", index=False)

# Save to GeoJSON for Leaflet
grid_gdf.to_file("data/AQHI_PAZA_grid.geojson", driver="GeoJSON")
